...
<div class="row">
    ...
    <div class="col-75">
        <input type="email" id="practice_email" placeholder="Eg. john@example.com" oninvalid="alert('Your email is invalid!');" name="practice_email" value="<?php echo $practice['practice_email'] ?>">
    </div>
</div>
<div class="row">
